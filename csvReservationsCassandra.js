...
function writeOneHundredReservations(writer, encoding, callback, openTime = '13:00', closeTime = '17:00', maxNumber = 4, minNumber = 8, resLimit = 120, monthsAhead = 3, restaurantData = 'Mark\'s Restaurant,12:00,20:00,12:00,20:00,12:00,20:00,12:00,20:00,12:00,20:00,9:00,20:00,9:00,20:00,true,13,2,120,2,10,9,6,5,4,3,2,2,0,0,0,0,0,0,0', reservationAllowed = true) {
  ...
  function write() {
    ...
    do {
      ...
      if (!reservationAllowed) {
        ...
        if (resLimit === 60) {
          data = restaurantData.concat(`,${id},${date},${startTime},${endTime},${startTime},${time2},${time3},${endTime},${''},${''},${''},${''},${numberPeople},${firstName},${lastName},${email},${phoneNumber},${notes}\n`);
        } else if (resLimit === 90) {
          data = restaurantData.concat(`,${id},${date},${startTime},${endTime},${startTime},${time2},${time3},${time4},${time5},${endTime},${''},${''},${numberPeople},${firstName},${lastName},${email},${phoneNumber},${notes}\n`);
        } else {
          data = restaurantData.concat(`,${id},${date},${startTime},${endTime},${startTime},${time2},${time3},${time4},${time5},${time6},${time7},${endTime},${numberPeople},${firstName},${lastName},${email},${phoneNumber},${notes}\n`);
        }
      }
