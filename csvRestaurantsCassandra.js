...
const write = fs.createWriteStream('./restaurantsTestCassandra.csv');
...
function writeTenMillionRestaurants(writer, encoding, callback) {
  ...
  function write() {
    ...
    do {
      ...
      const reservationAllowed = restaurantId === 1 ? true : getRandomElement([true, false]);
      ...
      weekdayHoursStart, weekdayHoursEnd, maxNumber, minNumber, reservationDuration, allowedMonthsAhead, data, reservationAllowed);
